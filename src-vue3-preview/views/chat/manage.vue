<template>
  <div class="app-container">
    ...
    <div class="filter-container">
      <el-button type="primary" plain class="filter-item" @click="add()"
        >添加
      </el-button>
      <div style="float: right; display: flex">
        <el-input
          v-model:value="params.admin_user_id"
          placeholder="管理员ID"
    ...
    <el-dialog title="发送一条消息" v-model:visible="dialogVisible" width="60%">
