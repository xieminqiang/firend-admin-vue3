    ...
    <div class="app-container">
        ...
        <div class="filter-container">
            <div style="float: right; display: flex">
                ...
                <el-select v-model="params.is_admin_proxy" placeholder="真人||AI">
                    <el-option
        ...
        <el-table v-loading="table_loading"
            ...
            <el-table-column align="center"
                ...
                <template slot-scope="scope">
                    <el-tag v-if="scope.row.sex == 'female' "
                            type="success">女
                    </el-tag>
                    <el-tag v-else
                            type="success">男
            ...
            <el-table-column align="center"
                             label="填报状态"
                             prop="is_complete_info">
                <template slot-scope="scope">
                    <el-tag v-if="scope.row.is_complete_info == 'Y' "
                            type="success">已完成
                    </el-tag>
                    <el-tag v-else
                            type="danger">填报中
