    ...
    <div class="app-container">
        ...
        <div class="filter-container">
            ...
            <div style="float: right; display: flex">
                <el-input v-model="params.admin_user_id"
                          placeholder="管理员ID"
                          style="width: 200px; margin: 0 3px"
                          class="filter-item"/>
                <el-input v-model="params.user_id"
                            placeholder="用户ID"
                            style="width: 200px; margin: 0 3px"
                            class="filter-item"/>
        ...
        <el-table v-loading="table_loading" element-loading-text="加载中..." border :data="list">
            ...
            <el-table-column label="管理员ID" prop="admin_user_id" align="center" show-overflow-tooltip/>
            <el-table-column label="用户ID" prop="user_id" align="center" show-overflow-tooltip/>
            <el-table-column label="创建时间" prop="created_at" align="center" :formatter="(row, column) =>formatDate(row.created_at)" show-overflow-tooltip width="160px"/>
            ...
            <el-table-column align="center" width="180px" label="操作">
                <template slot-scope="scope">
                    ...
                    <el-button  size="mini" type="primary" @click="handleGreet(scope.$index, scope.row)">发消息</el-button>
                </template>
            </el-table-column>
        </el-table>
...
export default {
    ...
    data() {
        return {
            ...
            data: {
                list:[{id:1,admin_user_id: '385f41aa-1360-11ee-be56-0242ac120002',user_id:'10008888'}],
                total:3,
            },
            dialogVisible:false,
            state: '',
