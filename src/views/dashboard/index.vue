            ...
            <div class="welcome-content">
                <div class="welcome-info">
                    ...
                    <div class="welcome-stats">
                        ...
                        <div class="stat-item">
                            <span class="stat-number">{{ getCurrentTime() }}</span>
            ...
            <div class="quick-actions">
                <el-card class="action-card">
                    ...
                    <div class="action-buttons">
                        ...
                        <el-button type="info" size="medium" class="action-btn">
...
.welcome-banner {
    ...
    .floating-hearts {
        ...
        .heart {
            ...
            &:nth-child(1) { animation-delay: 0s; top: 0px; right: 0px; }
            &:nth-child(2) { animation-delay: 1s; top: 30px; right: 40px; }
            &:nth-child(3) { animation-delay: 2s; top: -20px; right: 80px; }
            &:nth-child(4) { animation-delay: 1.5s; top: 50px; right: 20px; }
        }
    }
}
